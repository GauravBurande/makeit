...
interface IInteriorImage extends Document {
  ...
  beforeImageSize: string; // Image size of the before image (e.g., 1920x1080)
  afterImageSize: string; // Image size of the after image
